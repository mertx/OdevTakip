Public Class Metro_Sinif
    ...
    Private Sub ButtonSil_MouseEnter(sender As Object, e As EventArgs) Handles ButtonSil.MouseEnter
        DevComponents.DotNetBar.ToastNotification.Show(Me, "Seçili sınıfı sil", 1000, DevComponents.DotNetBar.eToastPosition.BottomCenter)
    End Sub

    Private Sub ButtonDuzenle_MouseEnter(sender As Object, e As EventArgs) Handles ButtonDuzenle.MouseEnter
        DevComponents.DotNetBar.ToastNotification.Show(Me, "Seçili sınıfı düzenle", 1000, DevComponents.DotNetBar.eToastPosition.BottomCenter)
    End Sub

    Private Sub ButtonEkle_MouseEnter(sender As Object, e As EventArgs) Handles ButtonEkle.MouseEnter
        DevComponents.DotNetBar.ToastNotification.Show(Me, "Yeni sınıf ekle", 1000, DevComponents.DotNetBar.eToastPosition.BottomCenter)
    End Sub
End Class
